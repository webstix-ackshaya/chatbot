    ...
    $(document).ready(function(){
        ...
        {                
            ...
            if($v==5)
            {
                ...
                {  
                    $msg3='<br/>ENTER THE CURRENT TECHNOLOGY : <input type="text" id="tb1"><br/><input type="button" id="tb2" value="submit"><br/>';
                    $(".form").append($msg3);
                    $("#tb2").click(function()
                {
                    $msg4='<br/>Thats great! Which platform you want to migrate to?<br/><br/> <input type="text" id="tb3"><br/><input type="button" id="tb4" value="submit"><br/>';
                    $(".form").append($msg4);
